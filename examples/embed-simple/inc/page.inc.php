      ...
      <form action="index.php" method="POST">
        ...
        <fieldset>
          ...
          <div class="row">
            ...
            <div class="col-75">
              <input autocomplete="off" type="text" name="title" id="title" value="">
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-75">
              <textarea autocomplete="off" name="description" id="description" cols="30" rows="4"></textarea>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-75">
              <input autocomplete="off" type="text" name="title_url" id="title_url" value="">
            </div>
          </div>
        ...
        <fieldset>
          ...
          <div class="row">
            ...
            <div class="col-75">
              <textarea autocomplete="off" name="message" id="message" cols="30" rows="4"></textarea>
            </div>
          </div>
